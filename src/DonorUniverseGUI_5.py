...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1208, 985))
    ...
    def searchDonors(self):
        ...
        headerBoxes = [self.donorCheck, self.safetyRatingCheck, self.bmiCheck, self.waistCheck, self.ageCheck,
                       self.genderCheck, self.clinicalInfoCheck, self.processStatusCheck, self.shippingCheck, self.materialCheck, 
