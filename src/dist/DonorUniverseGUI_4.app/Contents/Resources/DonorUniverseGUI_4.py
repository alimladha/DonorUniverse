...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1208, 991))
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_2, 16, 1, 1, 1)
        ...
        self.donorCheck.setObjectName(_fromUtf8("checkBox"))
        ...
        self.gridLayout_3.addWidget(self.materialCheck, 12, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.shippingCheck, 11, 2, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout, 16, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.currentStudiesCheck, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.logisticsHeader, 10, 0, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_3, 16, 3, 1, 1)
        ...
        self.shippingCombo.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.shippingCombo, 11, 3, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_9, 12, 2, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_8, 12, 1, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_10, 12, 3, 1, 1)
        self.line_2 = QtGui.QFrame(self.scrollAreaWidgetContents_3)
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName(_fromUtf8("line_2"))
        self.gridLayout_3.addWidget(self.line_2, 9, 0, 1, 4)
        ...
        self.gridLayout_3.addWidget(self.sixteenSHeader, 15, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.processStatusCheck, 11, 0, 1, 1)
        ...
        self.processStatusCombo.addItem(_fromUtf8(""))
        self.processStatusCombo.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.processStatusCombo, 11, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.prodRateCheck, 14, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.sixteenSHeader_2, 16, 0, 1, 1)
    ...
    def getFormInfo(self):
        formFields = [self.donorCheck, self.donorSpin, self.safetyRatingCheck, self.safetyRatingCombo, self.currentStudiesCheck, self.bmiCheck, 
