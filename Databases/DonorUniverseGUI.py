...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        materialCombos = [self.materialTypeCombo_1, self.materialTypeCombo_2, self.materialTypeCombo_3]
        ...
        materialSpins = [self.unitsSpin_1, self.unitsSpin_2, self.unitsSpin_3]
